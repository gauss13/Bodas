...
namespace ApiBodas.Controllers
{
    ...
    public class HotelController : ControllerBase
    {
        ...
        public HotelController(IRepositorioWrapper rw)
        {
            Repositorio = rw;
        }
        ...
        {
            var item = await this.Repositorio.Hoteles.GetByIdAsync(id);
        ...
        {
            var lista = await this.Repositorio.Hoteles.GetAllAsyc();
        ...
        //[HttpPost]
        //public async Task<IActionResult> Crear([FromBody] Hotel item)
        //{
        //    try
        //    {

        //        var r = await this.Repositorio.Hoteles.AddAsync(item);
        ...
        //[HttpPut("{id}")]
        //public async Task<IActionResult> Actualizar([FromBody] Hotel itemNuevo, int id)
        //{
        ...
        //        var itemEncontrado = await this.Repositorio.Hoteles.GetByIdAsync(id);
        ...
        //        var r = this.Repositorio.Hoteles.Update(itemEncontrado);
        //        await this.Repositorio.CompleteAsync();

        //        var obj = new
        //        {
        //            ok = true,
        //            Hotel = itemEncontrado
        //        };
